...
public class Config {
   ...
   public static final String URL_REGISTER ="http://www.sasurie.com//aptitude/db/registerfortechnotude.php";
...
/*
 public static final String URL_REGISTER ="http://192.168.43.205//aptitude/db/registerfortechnotude.php";
  public static final String URL_LOGIN  = "http://192.168.43.205/aptitude/db/validate.php";
  public static final String URL_RESULT = "http://192.168.43.205/aptitude/db/setresult.php";
  ...
  */
  ...
  //  public static final String URL_GET_QUESTION = "http://192.168.43.40/aptitude/db/getquestion.php?testid=";
    ...
    public static final String TEST_DATE="time" ;
