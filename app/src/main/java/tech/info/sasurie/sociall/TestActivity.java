...
public class TestActivity extends AppCompatActivity {
    ...
    private String regno,testname,reg_id,CurrentuserId,testdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  sharedpreferences = getSharedPreferences(MyPREFERENCES, Context.MODE_PRIVATE);
        ...
        testdate=intent.getStringExtra(Config.TEST_DATE);
    ...
    public void submitClick(int i){
        ...
        intent.putExtra(Config.TEST_DATE,testdate);
        intent.putExtra("count",ss);
    ...
    public void onBackPressed() {
        Intent TestViewIntent=new Intent(TestActivity.this,TestViewActivity.class);
